RunMQLearnerDiffDecayToPessPrior <- function(parameters, train_df, helpers, SIT_df=NULL, mle_means=NULL, mle_covar=NULL) { 
  ### Q-learner with decay — that varies by condition —  to a pess prior ###
  ...
  for (tr in 1:length(states)) {
    ...
    # Note: LSE test code is in `RunMQLearnerDecayToPessPrior`  
