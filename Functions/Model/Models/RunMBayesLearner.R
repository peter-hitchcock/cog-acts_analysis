RunMBayesLearner <- function(parameters, train_df, helpers, SIT_df=NULL, mle_means=NULL, mle_covar=NULL) { 
  ...
  for (tr in 1:length(states)) {
    ...
    choice_kernel <- NULL; this_choice_kernel <- NULL; bayes_Q_vals <- NULL; a1_row <- NULL; a2_row <- NULL
    if (cond=="cog") {
